<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MultiviewTest.aspx.cs" Inherits="StudentRegistrationApplication.MultiviewTest" %>
            ...
            <form id="form1" runat="server">
                <div class="row content">
                    <div class="col-sm-2 sidenav">
                        ...
                        <p><asp:Button ID="ViewProfileButton" runat="server" Text="View Profile" BackColor="Red" BorderStyle="None" Font-Size="Medium" ForeColor="White" Height="50px" OnClick="ViewProfileButton_Click" Width="120px" /></p>
                        <p><asp:Button ID="EditProfileButton" runat="server" Text="Edit Profile" BackColor="Red" BorderStyle="None" Font-Size="Medium" ForeColor="White" Height="50px" Width="120px" OnClick="EditProfileButton_Click" /></p>                        
                    </div>  
                    <div class="col-sm-6">                        
